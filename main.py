...
def place_the_item_in_a_tree(
    element: BinaryTreeElement, position_x: int, position_y: int
) -> None:
    if (
        element.return_best_main_premise() is not None
        and element.find_best_entropy() is not None
    ):
        ...
        print(
            f"Max(I-Ej): {element.return_best_main_premise()} {element.find_best_entropy()}"
        )
...
def create_an_option_to_table(
    sheet, min_row: int, min_col: int, max_row: int, max_col: int, table=None
):
    if table is None:
        table = []
...
def run_example():
    ...
    for number, col in enumerate(
        sheet.iter_cols(min_row=2, min_col=3, max_row=20, max_col=102)
    ):
        for index, cell in enumerate(col):
            if cell.value is not None:
                if 0 <= index <= 3:
                    ...
                    premises["konkluzja(wybór pizzy):"] = option_of_conclusion[
                        index - 16
                    ]
    ...
    LL = BinaryTreeElement(
        L.return_left_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    LR = BinaryTreeElement(
        L.return_right_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    RL = BinaryTreeElement(
        R.return_left_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    RR = BinaryTreeElement(
        R.return_right_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    LLL = BinaryTreeElement(
        LL.return_left_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    LLR = BinaryTreeElement(
        LL.return_right_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    RRL = BinaryTreeElement(
        RR.return_left_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    RRR = BinaryTreeElement(
        RR.return_right_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    LLRL = BinaryTreeElement(
        LLR.return_left_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    LLRR = BinaryTreeElement(
        LLR.return_right_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    RRLL = BinaryTreeElement(
        RRL.return_left_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    RRLR = BinaryTreeElement(
        RRL.return_right_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    LLRLL = BinaryTreeElement(
        LLRL.return_left_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    LLRLR = BinaryTreeElement(
        LLRL.return_right_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    RRLRL = BinaryTreeElement(
        RRLR.return_left_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    RRLRR = BinaryTreeElement(
        RRLR.return_right_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    LLRLRL = BinaryTreeElement(
        LLRLR.return_left_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    LLRLRR = BinaryTreeElement(
        LLRLR.return_right_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    RRLRRL = BinaryTreeElement(
        RRLRR.return_left_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    RRLRRR = BinaryTreeElement(
        RRLRR.return_right_branch(),
        conclusion,
        main_premises,
        option_of_premises,
        option_of_conclusion,
    ...
    salary = Label(
        window,
        text="zar. mies. - zarobki miesięczne danej osoby",
        font=("Times New Roman", 20),
    )

    meals = Label(
        window,
        text="ost. posiłek - czas od ostatniego posiłku danej osoby",
        font=("Times New Roman", 20),
    )

    persons_eating = Label(
        window,
        text="os. spoż. pizze - liczba osób spożywających pizzę",
        font=("Times New Roman", 20),
    )
